...
- Engineered a hybrid decision pipeline to suppress false positives caused by radiological artefacts and metallic restorations.
...
- [Online Voting Platform](https://github.com/florian-ariasu/online-voting-platform) — OOP voting system with election, candidate, and voter management. `Java` `Gradle`
